...
Interface::Interface(){
  ...
  _AAide= AAide(this);
  _AStats= AStats(this);
  _AEquipement= AEquipement(this);
  _ACorps= ACorps(this);
  _AInventaireSplit= AInventaireSplit(this);
  _AInventaire= AInventaire(this);
  _AArmures= AArmures(this);
  _AArmes= AArmes(this);
  _AObjets= AObjets(this);
  _ADialogues= ADialogues(this);
  _etatCourant= _ABase;
}
...
void setEtat(Etat etat){_etatCourant = etat;}
